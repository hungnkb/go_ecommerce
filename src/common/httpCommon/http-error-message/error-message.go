...
const (
	...
	ERROR_INSERT_PRODUCT_METADATA               = "Insert product metadata failed"
	ERROR_INSERT_PRODUCT                        = "Insert product failed"
	ERROR_INSERT_PRODUCT_ATTRIBUTE              = "Insert attributes failed"
)
